...
func Createresourcev1beta1namespacedresourceclaimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateresourcev1beta1namespacedresourceclaimTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_resource.k8s.io_v1beta1_namespaces_namespace_resourceclaims",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createresourcev1beta1namespacedresourceclaimHandler(cfg),
	}
}
