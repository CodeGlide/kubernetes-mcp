...
func Replaceresourcev1beta1namespacedresourceclaimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceresourcev1beta1namespacedresourceclaimTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_resource.k8s.io_v1beta1_namespaces_namespace_resourceclaims_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1beta1namespacedresourceclaimHandler(cfg),
	}
}
