...
func Deleteresourcev1beta1collectionnamespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/resource.k8s.io/v1beta1/namespaces/%s/resourceclaimtemplates%s", cfg.BaseURL, queryString)
...
func CreateDeleteresourcev1beta1collectionnamespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_resource.k8s.io_v1beta1_namespaces_namespace_resourceclaimtemplates",
		mcp.WithDescription("delete collection of ResourceClaimTemplate"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteresourcev1beta1collectionnamespacedresourceclaimtemplateHandler(cfg),
	}
}
