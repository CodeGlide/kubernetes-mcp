...
func Replaceresourcev1beta1deviceclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiresourcev1beta1DeviceClass
...
func CreateReplaceresourcev1beta1deviceclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_resource.k8s.io_v1beta1_deviceclasses_name",
		mcp.WithDescription("replace the specified DeviceClass"),
		...
		mcp.WithObject("spec", mcp.Required(), mcp.Description("Input parameter: DeviceClassSpec is used in a [DeviceClass] to define what can be allocated and how to configure it.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1beta1deviceclassHandler(cfg),
	}
}
