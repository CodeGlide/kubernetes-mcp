...
func Listresourcev1beta1namespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiresourcev1beta1ResourceClaimTemplateList
...
func CreateListresourcev1beta1namespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_resource.k8s.io_v1beta1_namespaces_namespace_resourceclaimtemplates",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listresourcev1beta1namespacedresourceclaimtemplateHandler(cfg),
	}
}
