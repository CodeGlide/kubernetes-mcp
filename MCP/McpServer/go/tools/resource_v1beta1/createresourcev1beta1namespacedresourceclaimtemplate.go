...
func Createresourcev1beta1namespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateresourcev1beta1namespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_resource.k8s.io_v1beta1_namespaces_namespace_resourceclaimtemplates",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createresourcev1beta1namespacedresourceclaimtemplateHandler(cfg),
	}
}
