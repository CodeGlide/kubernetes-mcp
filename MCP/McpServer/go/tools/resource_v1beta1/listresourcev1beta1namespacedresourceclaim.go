...
func Listresourcev1beta1namespacedresourceclaimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiresourcev1beta1ResourceClaimList
...
func CreateListresourcev1beta1namespacedresourceclaimTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_resource.k8s.io_v1beta1_namespaces_namespace_resourceclaims",
		mcp.WithDescription("list or watch objects of kind ResourceClaim"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listresourcev1beta1namespacedresourceclaimHandler(cfg),
	}
}
