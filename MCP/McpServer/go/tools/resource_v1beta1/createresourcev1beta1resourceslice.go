...
func Createresourcev1beta1resourcesliceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateresourcev1beta1resourcesliceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_resource.k8s.io_v1beta1_resourceslices",
		mcp.WithDescription("create a ResourceSlice"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createresourcev1beta1resourcesliceHandler(cfg),
	}
}
