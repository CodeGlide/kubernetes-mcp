...
func Deleteresourcev1beta1collectionnamespacedresourceclaimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/resource.k8s.io/v1beta1/namespaces/%s/resourceclaims%s", cfg.BaseURL, queryString)
...
func CreateDeleteresourcev1beta1collectionnamespacedresourceclaimTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_resource.k8s.io_v1beta1_namespaces_namespace_resourceclaims",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteresourcev1beta1collectionnamespacedresourceclaimHandler(cfg),
	}
}
