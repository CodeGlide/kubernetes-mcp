...
func Replaceresourcev1beta1namespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiresourcev1beta1ResourceClaimTemplate
...
func CreateReplaceresourcev1beta1namespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_resource.k8s.io_v1beta1_namespaces_namespace_resourceclaimtemplates_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1beta1namespacedresourceclaimtemplateHandler(cfg),
	}
}
