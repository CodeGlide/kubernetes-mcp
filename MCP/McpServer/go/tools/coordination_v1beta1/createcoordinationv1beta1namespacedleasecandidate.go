...
func Createcoordinationv1beta1namespacedleasecandidateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatecoordinationv1beta1namespacedleasecandidateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_coordination.k8s.io_v1beta1_namespaces_namespace_leasecandidates",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createcoordinationv1beta1namespacedleasecandidateHandler(cfg),
	}
}
