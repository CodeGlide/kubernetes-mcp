...
func Replacecoordinationv1beta1namespacedleasecandidateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapicoordinationv1beta1LeaseCandidate
		...
		var result models.Iok8sapicoordinationv1beta1LeaseCandidate
...
func CreateReplacecoordinationv1beta1namespacedleasecandidateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_coordination.k8s.io_v1beta1_namespaces_namespace_leasecandidates_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacecoordinationv1beta1namespacedleasecandidateHandler(cfg),
	}
}
