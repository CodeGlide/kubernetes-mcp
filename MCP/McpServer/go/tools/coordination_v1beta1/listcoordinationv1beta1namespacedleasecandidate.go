...
func Listcoordinationv1beta1namespacedleasecandidateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapicoordinationv1beta1LeaseCandidateList
...
func CreateListcoordinationv1beta1namespacedleasecandidateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_coordination.k8s.io_v1beta1_namespaces_namespace_leasecandidates",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcoordinationv1beta1namespacedleasecandidateHandler(cfg),
	}
}
