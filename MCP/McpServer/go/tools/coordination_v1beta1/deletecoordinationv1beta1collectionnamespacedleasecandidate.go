...
func Deletecoordinationv1beta1collectionnamespacedleasecandidateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/coordination.k8s.io/v1beta1/namespaces/%s/leasecandidates%s", cfg.BaseURL, queryString)
...
func CreateDeletecoordinationv1beta1collectionnamespacedleasecandidateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_coordination.k8s.io_v1beta1_namespaces_namespace_leasecandidates",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecoordinationv1beta1collectionnamespacedleasecandidateHandler(cfg),
	}
}
