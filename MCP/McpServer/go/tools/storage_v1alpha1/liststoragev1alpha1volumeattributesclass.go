...
func Liststoragev1alpha1volumeattributesclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapistoragev1alpha1VolumeAttributesClassList
...
func CreateListstoragev1alpha1volumeattributesclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_storage.k8s.io_v1alpha1_volumeattributesclasses",
		mcp.WithDescription("list or watch objects of kind VolumeAttributesClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Liststoragev1alpha1volumeattributesclassHandler(cfg),
	}
}
