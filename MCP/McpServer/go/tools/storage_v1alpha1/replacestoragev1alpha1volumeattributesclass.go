...
func Replacestoragev1alpha1volumeattributesclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapistoragev1alpha1VolumeAttributesClass
...
func CreateReplacestoragev1alpha1volumeattributesclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_storage.k8s.io_v1alpha1_volumeattributesclasses_name",
		mcp.WithDescription("replace the specified VolumeAttributesClass"),
		...
		mcp.WithString("driverName", mcp.Required(), mcp.Description("Input parameter: Name of the CSI driver This field is immutable.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacestoragev1alpha1volumeattributesclassHandler(cfg),
	}
}
