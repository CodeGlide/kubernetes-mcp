...
func Createstoragev1alpha1volumeattributesclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatestoragev1alpha1volumeattributesclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_storage.k8s.io_v1alpha1_volumeattributesclasses",
		mcp.WithDescription("create a VolumeAttributesClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createstoragev1alpha1volumeattributesclassHandler(cfg),
	}
}
