...
func Deletestoragev1alpha1collectionvolumeattributesclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/storage.k8s.io/v1alpha1/volumeattributesclasses%s", cfg.BaseURL, queryString)
...
func CreateDeletestoragev1alpha1collectionvolumeattributesclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage.k8s.io_v1alpha1_volumeattributesclasses",
		mcp.WithDescription("delete collection of VolumeAttributesClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletestoragev1alpha1collectionvolumeattributesclassHandler(cfg),
	}
}
