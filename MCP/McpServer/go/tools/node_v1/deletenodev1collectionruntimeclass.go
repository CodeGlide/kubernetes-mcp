...
func Deletenodev1collectionruntimeclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/node.k8s.io/v1/runtimeclasses%s", cfg.BaseURL, queryString)
...
func CreateDeletenodev1collectionruntimeclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_node.k8s.io_v1_runtimeclasses",
		mcp.WithDescription("delete collection of RuntimeClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletenodev1collectionruntimeclassHandler(cfg),
	}
}
