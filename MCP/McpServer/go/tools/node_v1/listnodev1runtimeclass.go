...
func Listnodev1runtimeclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapinodev1RuntimeClassList
...
func CreateListnodev1runtimeclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_node.k8s.io_v1_runtimeclasses",
		mcp.WithDescription("list or watch objects of kind RuntimeClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listnodev1runtimeclassHandler(cfg),
	}
}
