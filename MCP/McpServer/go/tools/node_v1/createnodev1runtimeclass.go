...
func Createnodev1runtimeclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenodev1runtimeclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_node.k8s.io_v1_runtimeclasses",
		mcp.WithDescription("create a RuntimeClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createnodev1runtimeclassHandler(cfg),
	}
}
