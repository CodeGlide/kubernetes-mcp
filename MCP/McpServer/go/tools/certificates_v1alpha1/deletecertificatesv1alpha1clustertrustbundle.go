...
func Deletecertificatesv1alpha1clustertrustbundleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecertificatesv1alpha1clustertrustbundleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_certificates.k8s.io_v1alpha1_clustertrustbundles_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecertificatesv1alpha1clustertrustbundleHandler(cfg),
	}
}
