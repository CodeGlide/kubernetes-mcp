...
func Listcertificatesv1alpha1clustertrustbundleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapicertificatesv1alpha1ClusterTrustBundleList
...
func CreateListcertificatesv1alpha1clustertrustbundleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_certificates.k8s.io_v1alpha1_clustertrustbundles",
		mcp.WithDescription("list or watch objects of kind ClusterTrustBundle"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcertificatesv1alpha1clustertrustbundleHandler(cfg),
	}
}
