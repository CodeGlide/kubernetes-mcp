...
func Replacecertificatesv1alpha1clustertrustbundleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacecertificatesv1alpha1clustertrustbundleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_certificates.k8s.io_v1alpha1_clustertrustbundles_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacecertificatesv1alpha1clustertrustbundleHandler(cfg),
	}
}
