...
func Createcertificatesv1alpha1clustertrustbundleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapicertificatesv1alpha1ClusterTrustBundle
...
func CreateCreatecertificatesv1alpha1clustertrustbundleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_certificates.k8s.io_v1alpha1_clustertrustbundles",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createcertificatesv1alpha1clustertrustbundleHandler(cfg),
	}
}
