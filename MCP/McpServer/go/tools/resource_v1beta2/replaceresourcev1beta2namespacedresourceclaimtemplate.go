...
func Replaceresourcev1beta2namespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiresourcev1beta2ResourceClaimTemplate
...
func CreateReplaceresourcev1beta2namespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_resource.k8s.io_v1beta2_namespaces_namespace_resourceclaimtemplates_name",
		mcp.WithDescription("replace the specified ResourceClaimTemplate"),
		...
		mcp.WithObject("spec", mcp.Required(), mcp.Description("Input parameter: ResourceClaimTemplateSpec contains the metadata and fields for a ResourceClaim.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1beta2namespacedresourceclaimtemplateHandler(cfg),
	}
}
