...
func Replaceresourcev1beta2deviceclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiresourcev1beta2DeviceClass
...
func CreateReplaceresourcev1beta2deviceclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_resource.k8s.io_v1beta2_deviceclasses_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1beta2deviceclassHandler(cfg),
	}
}
