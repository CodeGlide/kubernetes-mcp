...
func Replaceresourcev1beta2resourcesliceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiresourcev1beta2ResourceSlice
...
func CreateReplaceresourcev1beta2resourcesliceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_resource.k8s.io_v1beta2_resourceslices_name",
		mcp.WithDescription("replace the specified ResourceSlice"),
		...
		mcp.WithObject("spec", mcp.Required(), mcp.Description("Input parameter: ResourceSliceSpec contains the information published by the driver in one ResourceSlice.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1beta2resourcesliceHandler(cfg),
	}
}
