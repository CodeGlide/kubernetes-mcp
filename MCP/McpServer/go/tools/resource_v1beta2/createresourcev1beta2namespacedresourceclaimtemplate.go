...
func Createresourcev1beta2namespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateresourcev1beta2namespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_resource.k8s.io_v1beta2_namespaces_namespace_resourceclaimtemplates",
		mcp.WithDescription("create a ResourceClaimTemplate"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createresourcev1beta2namespacedresourceclaimtemplateHandler(cfg),
	}
}
