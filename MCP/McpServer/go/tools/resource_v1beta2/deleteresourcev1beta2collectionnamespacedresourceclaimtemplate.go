...
func Deleteresourcev1beta2collectionnamespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/resource.k8s.io/v1beta2/namespaces/%s/resourceclaimtemplates%s", cfg.BaseURL, queryString)
...
func CreateDeleteresourcev1beta2collectionnamespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_resource.k8s.io_v1beta2_namespaces_namespace_resourceclaimtemplates",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteresourcev1beta2collectionnamespacedresourceclaimtemplateHandler(cfg),
	}
}
