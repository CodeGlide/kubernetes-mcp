...
func Listresourcev1beta2resourcesliceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiresourcev1beta2ResourceSliceList
...
func CreateListresourcev1beta2resourcesliceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_resource.k8s.io_v1beta2_resourceslices",
		mcp.WithDescription("list or watch objects of kind ResourceSlice"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listresourcev1beta2resourcesliceHandler(cfg),
	}
}
