...
func Listresourcev1beta2namespacedresourceclaimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiresourcev1beta2ResourceClaimList
...
func CreateListresourcev1beta2namespacedresourceclaimTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_resource.k8s.io_v1beta2_namespaces_namespace_resourceclaims",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listresourcev1beta2namespacedresourceclaimHandler(cfg),
	}
}
