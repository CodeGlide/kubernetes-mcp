...
func Createresourcev1beta2deviceclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateresourcev1beta2deviceclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_resource.k8s.io_v1beta2_deviceclasses",
		mcp.WithDescription("create a DeviceClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createresourcev1beta2deviceclassHandler(cfg),
	}
}
