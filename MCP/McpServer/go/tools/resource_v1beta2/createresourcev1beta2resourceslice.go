...
func Createresourcev1beta2resourcesliceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateresourcev1beta2resourcesliceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_resource.k8s.io_v1beta2_resourceslices",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createresourcev1beta2resourcesliceHandler(cfg),
	}
}
