...
func Listadmissionregistrationv1validatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiadmissionregistrationv1ValidatingAdmissionPolicyBindingList
...
func CreateListadmissionregistrationv1validatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_admissionregistration.k8s.io_v1_validatingadmissionpolicybindings",
		mcp.WithDescription("list or watch objects of kind ValidatingAdmissionPolicyBinding"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listadmissionregistrationv1validatingadmissionpolicybindingHandler(cfg),
	}
}
