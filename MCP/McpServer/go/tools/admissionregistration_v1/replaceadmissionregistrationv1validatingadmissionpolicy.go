...
func Replaceadmissionregistrationv1validatingadmissionpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/admissionregistration.k8s.io/v1/validatingadmissionpolicies/%s%s", cfg.BaseURL, queryString)
...
func CreateReplaceadmissionregistrationv1validatingadmissionpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_admissionregistration.k8s.io_v1_validatingadmissionpolicies_name",
		mcp.WithDescription("replace the specified ValidatingAdmissionPolicy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceadmissionregistrationv1validatingadmissionpolicyHandler(cfg),
	}
}
