...
func Createadmissionregistrationv1validatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateadmissionregistrationv1validatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_admissionregistration.k8s.io_v1_validatingadmissionpolicybindings",
		mcp.WithDescription("create a ValidatingAdmissionPolicyBinding"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createadmissionregistrationv1validatingadmissionpolicybindingHandler(cfg),
	}
}
