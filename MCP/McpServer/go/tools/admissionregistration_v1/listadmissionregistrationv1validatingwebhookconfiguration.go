...
func Listadmissionregistrationv1validatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiadmissionregistrationv1ValidatingWebhookConfigurationList
...
func CreateListadmissionregistrationv1validatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_admissionregistration.k8s.io_v1_validatingwebhookconfigurations",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listadmissionregistrationv1validatingwebhookconfigurationHandler(cfg),
	}
}
