...
func Createadmissionregistrationv1mutatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiadmissionregistrationv1MutatingWebhookConfiguration
		...
		var result models.Iok8sapiadmissionregistrationv1MutatingWebhookConfiguration
...
func CreateCreateadmissionregistrationv1mutatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_admissionregistration.k8s.io_v1_mutatingwebhookconfigurations",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createadmissionregistrationv1mutatingwebhookconfigurationHandler(cfg),
	}
}
