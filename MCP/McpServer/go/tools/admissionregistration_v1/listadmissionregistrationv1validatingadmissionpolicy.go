...
func Listadmissionregistrationv1validatingadmissionpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiadmissionregistrationv1ValidatingAdmissionPolicyList
...
func CreateListadmissionregistrationv1validatingadmissionpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_admissionregistration.k8s.io_v1_validatingadmissionpolicies",
		mcp.WithDescription("list or watch objects of kind ValidatingAdmissionPolicy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listadmissionregistrationv1validatingadmissionpolicyHandler(cfg),
	}
}
