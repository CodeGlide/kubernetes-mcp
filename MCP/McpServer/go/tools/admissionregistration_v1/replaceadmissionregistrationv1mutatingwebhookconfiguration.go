...
func Replaceadmissionregistrationv1mutatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceadmissionregistrationv1mutatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_admissionregistration.k8s.io_v1_mutatingwebhookconfigurations_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceadmissionregistrationv1mutatingwebhookconfigurationHandler(cfg),
	}
}
