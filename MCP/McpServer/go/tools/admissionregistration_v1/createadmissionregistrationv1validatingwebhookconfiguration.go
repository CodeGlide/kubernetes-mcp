...
func Createadmissionregistrationv1validatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateadmissionregistrationv1validatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_admissionregistration.k8s.io_v1_validatingwebhookconfigurations",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createadmissionregistrationv1validatingwebhookconfigurationHandler(cfg),
	}
}
