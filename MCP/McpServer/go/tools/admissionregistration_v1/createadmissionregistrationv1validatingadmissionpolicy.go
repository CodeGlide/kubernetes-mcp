...
func Createadmissionregistrationv1validatingadmissionpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateadmissionregistrationv1validatingadmissionpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_admissionregistration.k8s.io_v1_validatingadmissionpolicies",
		mcp.WithDescription("create a ValidatingAdmissionPolicy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createadmissionregistrationv1validatingadmissionpolicyHandler(cfg),
	}
}
