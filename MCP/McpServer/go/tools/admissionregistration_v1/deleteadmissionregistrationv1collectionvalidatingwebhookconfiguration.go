...
func Deleteadmissionregistrationv1collectionvalidatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations%s", cfg.BaseURL, queryString)
...
func CreateDeleteadmissionregistrationv1collectionvalidatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_admissionregistration.k8s.io_v1_validatingwebhookconfigurations",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteadmissionregistrationv1collectionvalidatingwebhookconfigurationHandler(cfg),
	}
}
