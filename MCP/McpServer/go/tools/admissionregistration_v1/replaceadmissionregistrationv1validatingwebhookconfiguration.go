...
func Replaceadmissionregistrationv1validatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiadmissionregistrationv1ValidatingWebhookConfiguration
		...
		var result models.Iok8sapiadmissionregistrationv1ValidatingWebhookConfiguration
...
func CreateReplaceadmissionregistrationv1validatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_admissionregistration.k8s.io_v1_validatingwebhookconfigurations_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceadmissionregistrationv1validatingwebhookconfigurationHandler(cfg),
	}
}
