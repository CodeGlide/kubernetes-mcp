...
func Replaceadmissionregistrationv1validatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiadmissionregistrationv1ValidatingAdmissionPolicyBinding
		...
		var result models.Iok8sapiadmissionregistrationv1ValidatingAdmissionPolicyBinding
...
func CreateReplaceadmissionregistrationv1validatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_admissionregistration.k8s.io_v1_validatingadmissionpolicybindings_name",
		mcp.WithDescription("replace the specified ValidatingAdmissionPolicyBinding"),
		...
		mcp.WithObject("spec", mcp.Description("Input parameter: ValidatingAdmissionPolicyBindingSpec is the specification of the ValidatingAdmissionPolicyBinding.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Replaceadmissionregistrationv1validatingadmissionpolicybindingHandler(cfg),
	}
}
