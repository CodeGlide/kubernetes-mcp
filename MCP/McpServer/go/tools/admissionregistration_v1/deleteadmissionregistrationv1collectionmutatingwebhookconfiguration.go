...
func Deleteadmissionregistrationv1collectionmutatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations%s", cfg.BaseURL, queryString)
...
func CreateDeleteadmissionregistrationv1collectionmutatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_admissionregistration.k8s.io_v1_mutatingwebhookconfigurations",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteadmissionregistrationv1collectionmutatingwebhookconfigurationHandler(cfg),
	}
}
