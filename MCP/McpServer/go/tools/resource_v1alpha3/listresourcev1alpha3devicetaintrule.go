...
func Listresourcev1alpha3devicetaintruleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiresourcev1alpha3DeviceTaintRuleList
...
func CreateListresourcev1alpha3devicetaintruleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_resource.k8s.io_v1alpha3_devicetaintrules",
		mcp.WithDescription("list or watch objects of kind DeviceTaintRule"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listresourcev1alpha3devicetaintruleHandler(cfg),
	}
}
