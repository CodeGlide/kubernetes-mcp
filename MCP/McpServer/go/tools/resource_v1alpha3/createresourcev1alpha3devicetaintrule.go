...
func Createresourcev1alpha3devicetaintruleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateresourcev1alpha3devicetaintruleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_resource.k8s.io_v1alpha3_devicetaintrules",
		mcp.WithDescription("create a DeviceTaintRule"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createresourcev1alpha3devicetaintruleHandler(cfg),
	}
}
