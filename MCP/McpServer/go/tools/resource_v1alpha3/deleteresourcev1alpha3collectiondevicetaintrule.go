...
func Deleteresourcev1alpha3collectiondevicetaintruleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/resource.k8s.io/v1alpha3/devicetaintrules%s", cfg.BaseURL, queryString)
...
func CreateDeleteresourcev1alpha3collectiondevicetaintruleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_resource.k8s.io_v1alpha3_devicetaintrules",
		mcp.WithDescription("delete collection of DeviceTaintRule"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteresourcev1alpha3collectiondevicetaintruleHandler(cfg),
	}
}
