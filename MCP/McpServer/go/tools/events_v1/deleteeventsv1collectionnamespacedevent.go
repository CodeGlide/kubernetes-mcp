...
func Deleteeventsv1collectionnamespacedeventHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteeventsv1collectionnamespacedeventTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_events.k8s.io_v1_namespaces_namespace_events",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteeventsv1collectionnamespacedeventHandler(cfg),
	}
}
