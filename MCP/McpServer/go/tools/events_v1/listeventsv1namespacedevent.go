...
func Listeventsv1namespacedeventHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapieventsv1EventList
...
func CreateListeventsv1namespacedeventTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_events.k8s.io_v1_namespaces_namespace_events",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listeventsv1namespacedeventHandler(cfg),
	}
}
