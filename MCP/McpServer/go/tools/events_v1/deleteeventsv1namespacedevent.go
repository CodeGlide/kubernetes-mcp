...
func Deleteeventsv1namespacedeventHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteeventsv1namespacedeventTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_events.k8s.io_v1_namespaces_namespace_events_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteeventsv1namespacedeventHandler(cfg),
	}
}
