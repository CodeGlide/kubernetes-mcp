...
func Createstoragev1csinodeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatestoragev1csinodeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_storage.k8s.io_v1_csinodes",
		mcp.WithDescription("create a CSINode"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createstoragev1csinodeHandler(cfg),
	}
}
