...
func Liststoragev1csinodeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapistoragev1CSINodeList
...
func CreateListstoragev1csinodeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_storage.k8s.io_v1_csinodes",
		mcp.WithDescription("list or watch objects of kind CSINode"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Liststoragev1csinodeHandler(cfg),
	}
}
