...
func Createstoragev1csidriverHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatestoragev1csidriverTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_storage.k8s.io_v1_csidrivers",
		mcp.WithDescription("create a CSIDriver"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createstoragev1csidriverHandler(cfg),
	}
}
