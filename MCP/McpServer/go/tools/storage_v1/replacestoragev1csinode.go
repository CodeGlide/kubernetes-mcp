...
func Replacestoragev1csinodeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapistoragev1CSINode
...
func CreateReplacestoragev1csinodeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_storage.k8s.io_v1_csinodes_name",
		mcp.WithDescription("replace the specified CSINode"),
		...
		mcp.WithObject("spec", mcp.Required(), mcp.Description("Input parameter: CSINodeSpec holds information about the specification of all CSI drivers installed on a node")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacestoragev1csinodeHandler(cfg),
	}
}
