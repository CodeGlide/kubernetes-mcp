...
func Replacestoragev1volumeattachmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacestoragev1volumeattachmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_storage.k8s.io_v1_volumeattachments_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacestoragev1volumeattachmentHandler(cfg),
	}
}
