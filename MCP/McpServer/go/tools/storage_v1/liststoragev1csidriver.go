...
func Liststoragev1csidriverHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapistoragev1CSIDriverList
...
func CreateListstoragev1csidriverTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_storage.k8s.io_v1_csidrivers",
		mcp.WithDescription("list or watch objects of kind CSIDriver"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Liststoragev1csidriverHandler(cfg),
	}
}
