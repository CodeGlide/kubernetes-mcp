...
func Liststoragev1volumeattachmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapistoragev1VolumeAttachmentList
...
func CreateListstoragev1volumeattachmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_storage.k8s.io_v1_volumeattachments",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Liststoragev1volumeattachmentHandler(cfg),
	}
}
