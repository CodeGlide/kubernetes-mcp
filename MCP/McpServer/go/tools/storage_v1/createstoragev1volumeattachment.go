...
func Createstoragev1volumeattachmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatestoragev1volumeattachmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_storage.k8s.io_v1_volumeattachments",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createstoragev1volumeattachmentHandler(cfg),
	}
}
