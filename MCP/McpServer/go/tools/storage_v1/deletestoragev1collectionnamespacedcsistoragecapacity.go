...
func Deletestoragev1collectionnamespacedcsistoragecapacityHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletestoragev1collectionnamespacedcsistoragecapacityTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage.k8s.io_v1_namespaces_namespace_csistoragecapacities",
		mcp.WithDescription("delete collection of CSIStorageCapacity"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletestoragev1collectionnamespacedcsistoragecapacityHandler(cfg),
	}
}
