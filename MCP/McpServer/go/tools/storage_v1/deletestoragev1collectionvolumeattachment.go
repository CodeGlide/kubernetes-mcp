...
func Deletestoragev1collectionvolumeattachmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/storage.k8s.io/v1/volumeattachments%s", cfg.BaseURL, queryString)
...
func CreateDeletestoragev1collectionvolumeattachmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage.k8s.io_v1_volumeattachments",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletestoragev1collectionvolumeattachmentHandler(cfg),
	}
}
