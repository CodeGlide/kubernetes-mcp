...
func Deletestoragev1collectioncsidriverHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/storage.k8s.io/v1/csidrivers%s", cfg.BaseURL, queryString)
...
func CreateDeletestoragev1collectioncsidriverTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage.k8s.io_v1_csidrivers",
		mcp.WithDescription("delete collection of CSIDriver"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletestoragev1collectioncsidriverHandler(cfg),
	}
}
