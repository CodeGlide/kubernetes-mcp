...
func Deletestoragev1collectioncsinodeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/storage.k8s.io/v1/csinodes%s", cfg.BaseURL, queryString)
...
func CreateDeletestoragev1collectioncsinodeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage.k8s.io_v1_csinodes",
		mcp.WithDescription("delete collection of CSINode"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletestoragev1collectioncsinodeHandler(cfg),
	}
}
