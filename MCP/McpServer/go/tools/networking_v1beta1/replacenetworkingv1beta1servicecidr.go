...
func Replacenetworkingv1beta1servicecidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenetworkingv1beta1servicecidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_networking.k8s.io_v1beta1_servicecidrs_name",
		mcp.WithDescription("replace the specified ServiceCIDR"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacenetworkingv1beta1servicecidrHandler(cfg),
	}
}
