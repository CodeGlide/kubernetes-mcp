...
func Deletenetworkingv1beta1collectionservicecidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/networking.k8s.io/v1beta1/servicecidrs%s", cfg.BaseURL, queryString)
...
func CreateDeletenetworkingv1beta1collectionservicecidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_networking.k8s.io_v1beta1_servicecidrs",
		mcp.WithDescription("delete collection of ServiceCIDR"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletenetworkingv1beta1collectionservicecidrHandler(cfg),
	}
}
