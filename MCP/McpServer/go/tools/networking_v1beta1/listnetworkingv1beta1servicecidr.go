...
func Listnetworkingv1beta1servicecidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapinetworkingv1beta1ServiceCIDRList
...
func CreateListnetworkingv1beta1servicecidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_networking.k8s.io_v1beta1_servicecidrs",
		mcp.WithDescription("list or watch objects of kind ServiceCIDR"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listnetworkingv1beta1servicecidrHandler(cfg),
	}
}
