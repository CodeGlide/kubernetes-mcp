...
func Replacenetworkingv1beta1ipaddressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapinetworkingv1beta1IPAddress
		...
		var result models.Iok8sapinetworkingv1beta1IPAddress
...
func CreateReplacenetworkingv1beta1ipaddressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_networking.k8s.io_v1beta1_ipaddresses_name",
		mcp.WithDescription("replace the specified IPAddress"),
		...
		mcp.WithObject("spec", mcp.Description("Input parameter: IPAddressSpec describe the attributes in an IP Address.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacenetworkingv1beta1ipaddressHandler(cfg),
	}
}
