...
func Createnetworkingv1beta1servicecidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenetworkingv1beta1servicecidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_networking.k8s.io_v1beta1_servicecidrs",
		mcp.WithDescription("create a ServiceCIDR"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createnetworkingv1beta1servicecidrHandler(cfg),
	}
}
