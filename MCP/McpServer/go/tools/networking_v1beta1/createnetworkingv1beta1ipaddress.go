...
func Createnetworkingv1beta1ipaddressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenetworkingv1beta1ipaddressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_networking.k8s.io_v1beta1_ipaddresses",
		mcp.WithDescription("create an IPAddress"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createnetworkingv1beta1ipaddressHandler(cfg),
	}
}
