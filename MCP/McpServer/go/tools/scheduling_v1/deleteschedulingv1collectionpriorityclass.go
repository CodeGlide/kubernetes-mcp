...
func Deleteschedulingv1collectionpriorityclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/scheduling.k8s.io/v1/priorityclasses%s", cfg.BaseURL, queryString)
...
func CreateDeleteschedulingv1collectionpriorityclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_scheduling.k8s.io_v1_priorityclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteschedulingv1collectionpriorityclassHandler(cfg),
	}
}
