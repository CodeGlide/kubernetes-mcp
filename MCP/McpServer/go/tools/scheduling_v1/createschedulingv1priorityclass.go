...
func Createschedulingv1priorityclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateschedulingv1priorityclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_scheduling.k8s.io_v1_priorityclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createschedulingv1priorityclassHandler(cfg),
	}
}
