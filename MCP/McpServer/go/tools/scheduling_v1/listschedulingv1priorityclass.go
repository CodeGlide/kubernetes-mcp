...
func Listschedulingv1priorityclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapischedulingv1PriorityClassList
...
func CreateListschedulingv1priorityclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_scheduling.k8s.io_v1_priorityclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listschedulingv1priorityclassHandler(cfg),
	}
}
