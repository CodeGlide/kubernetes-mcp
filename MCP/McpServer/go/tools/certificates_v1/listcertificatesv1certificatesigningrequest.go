...
func Listcertificatesv1certificatesigningrequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapicertificatesv1CertificateSigningRequestList
...
func CreateListcertificatesv1certificatesigningrequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_certificates.k8s.io_v1_certificatesigningrequests",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcertificatesv1certificatesigningrequestHandler(cfg),
	}
}
