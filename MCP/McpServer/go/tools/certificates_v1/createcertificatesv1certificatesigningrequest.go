...
func Createcertificatesv1certificatesigningrequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatecertificatesv1certificatesigningrequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_certificates.k8s.io_v1_certificatesigningrequests",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createcertificatesv1certificatesigningrequestHandler(cfg),
	}
}
