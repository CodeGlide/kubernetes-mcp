...
func Deletecertificatesv1collectioncertificatesigningrequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/certificates.k8s.io/v1/certificatesigningrequests%s", cfg.BaseURL, queryString)
...
func CreateDeletecertificatesv1collectioncertificatesigningrequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_certificates.k8s.io_v1_certificatesigningrequests",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecertificatesv1collectioncertificatesigningrequestHandler(cfg),
	}
}
