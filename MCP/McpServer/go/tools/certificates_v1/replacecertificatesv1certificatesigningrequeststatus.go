...
func Replacecertificatesv1certificatesigningrequeststatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacecertificatesv1certificatesigningrequeststatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_certificates.k8s.io_v1_certificatesigningrequests_name_status",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacecertificatesv1certificatesigningrequeststatusHandler(cfg),
	}
}
