...
func Createnetworkingv1ipaddressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenetworkingv1ipaddressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_networking.k8s.io_v1_ipaddresses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createnetworkingv1ipaddressHandler(cfg),
	}
}
