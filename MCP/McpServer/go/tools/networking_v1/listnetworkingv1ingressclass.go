...
func Listnetworkingv1ingressclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapinetworkingv1IngressClassList
...
func CreateListnetworkingv1ingressclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_networking.k8s.io_v1_ingressclasses",
		mcp.WithDescription("list or watch objects of kind IngressClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listnetworkingv1ingressclassHandler(cfg),
	}
}
