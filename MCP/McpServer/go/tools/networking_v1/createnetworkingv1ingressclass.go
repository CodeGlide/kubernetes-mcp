...
func Createnetworkingv1ingressclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenetworkingv1ingressclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_networking.k8s.io_v1_ingressclasses",
		mcp.WithDescription("create an IngressClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createnetworkingv1ingressclassHandler(cfg),
	}
}
