...
func Replacenetworkingv1ingressclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapinetworkingv1IngressClass
		...
		var result models.Iok8sapinetworkingv1IngressClass
...
func CreateReplacenetworkingv1ingressclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_networking.k8s.io_v1_ingressclasses_name",
		mcp.WithDescription("replace the specified IngressClass"),
		...
		mcp.WithObject("spec", mcp.Description("Input parameter: IngressClassSpec provides information about the class of an Ingress.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Replacenetworkingv1ingressclassHandler(cfg),
	}
}
