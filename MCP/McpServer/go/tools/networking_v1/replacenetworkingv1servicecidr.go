...
func Replacenetworkingv1servicecidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenetworkingv1servicecidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_networking.k8s.io_v1_servicecidrs_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacenetworkingv1servicecidrHandler(cfg),
	}
}
