...
func Replacenetworkingv1servicecidrstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapinetworkingv1ServiceCIDR
		...
		url := fmt.Sprintf("%s/apis/networking.k8s.io/v1/servicecidrs/%s/status%s", cfg.BaseURL, queryString)
		...
		var result models.Iok8sapinetworkingv1ServiceCIDR
...
func CreateReplacenetworkingv1servicecidrstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_networking.k8s.io_v1_servicecidrs_name_status",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacenetworkingv1servicecidrstatusHandler(cfg),
	}
}
