...
func Createnetworkingv1servicecidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenetworkingv1servicecidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_networking.k8s.io_v1_servicecidrs",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createnetworkingv1servicecidrHandler(cfg),
	}
}
