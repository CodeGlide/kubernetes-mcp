...
func Listnetworkingv1ipaddressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapinetworkingv1IPAddressList
...
func CreateListnetworkingv1ipaddressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_networking.k8s.io_v1_ipaddresses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listnetworkingv1ipaddressHandler(cfg),
	}
}
