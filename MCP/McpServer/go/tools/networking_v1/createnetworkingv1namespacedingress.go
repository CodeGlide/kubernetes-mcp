...
func Createnetworkingv1namespacedingressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenetworkingv1namespacedingressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_networking.k8s.io_v1_namespaces_namespace_ingresses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createnetworkingv1namespacedingressHandler(cfg),
	}
}
