...
func Listnetworkingv1namespacedingressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapinetworkingv1IngressList
...
func CreateListnetworkingv1namespacedingressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_networking.k8s.io_v1_namespaces_namespace_ingresses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listnetworkingv1namespacedingressHandler(cfg),
	}
}
