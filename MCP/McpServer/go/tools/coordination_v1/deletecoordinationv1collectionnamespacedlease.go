...
func Deletecoordinationv1collectionnamespacedleaseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/coordination.k8s.io/v1/namespaces/%s/leases%s", cfg.BaseURL, queryString)
...
func CreateDeletecoordinationv1collectionnamespacedleaseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_coordination.k8s.io_v1_namespaces_namespace_leases",
		mcp.WithDescription("delete collection of Lease"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecoordinationv1collectionnamespacedleaseHandler(cfg),
	}
}
