...
func Listcoordinationv1namespacedleaseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapicoordinationv1LeaseList
...
func CreateListcoordinationv1namespacedleaseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_coordination.k8s.io_v1_namespaces_namespace_leases",
		mcp.WithDescription("list or watch objects of kind Lease"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcoordinationv1namespacedleaseHandler(cfg),
	}
}
