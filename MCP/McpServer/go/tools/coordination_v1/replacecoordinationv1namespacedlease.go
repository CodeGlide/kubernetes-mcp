...
func Replacecoordinationv1namespacedleaseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapicoordinationv1Lease
		...
		var result models.Iok8sapicoordinationv1Lease
...
func CreateReplacecoordinationv1namespacedleaseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_coordination.k8s.io_v1_namespaces_namespace_leases_name",
		mcp.WithDescription("replace the specified Lease"),
		...
		mcp.WithObject("spec", mcp.Description("Input parameter: LeaseSpec is a specification of a Lease.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacecoordinationv1namespacedleaseHandler(cfg),
	}
}
