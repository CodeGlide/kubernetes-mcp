...
func Createcoordinationv1namespacedleaseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatecoordinationv1namespacedleaseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_coordination.k8s.io_v1_namespaces_namespace_leases",
		mcp.WithDescription("create a Lease"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createcoordinationv1namespacedleaseHandler(cfg),
	}
}
