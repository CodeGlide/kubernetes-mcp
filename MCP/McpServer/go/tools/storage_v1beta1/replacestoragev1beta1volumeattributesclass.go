...
func Replacestoragev1beta1volumeattributesclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapistoragev1beta1VolumeAttributesClass
...
func CreateReplacestoragev1beta1volumeattributesclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_storage.k8s.io_v1beta1_volumeattributesclasses_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacestoragev1beta1volumeattributesclassHandler(cfg),
	}
}
