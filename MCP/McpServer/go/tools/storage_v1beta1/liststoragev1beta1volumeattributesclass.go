...
func Liststoragev1beta1volumeattributesclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapistoragev1beta1VolumeAttributesClassList
...
func CreateListstoragev1beta1volumeattributesclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_storage.k8s.io_v1beta1_volumeattributesclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Liststoragev1beta1volumeattributesclassHandler(cfg),
	}
}
