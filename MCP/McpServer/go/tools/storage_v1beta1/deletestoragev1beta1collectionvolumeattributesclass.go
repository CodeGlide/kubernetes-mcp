...
func Deletestoragev1beta1collectionvolumeattributesclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/storage.k8s.io/v1beta1/volumeattributesclasses%s", cfg.BaseURL, queryString)
...
func CreateDeletestoragev1beta1collectionvolumeattributesclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage.k8s.io_v1beta1_volumeattributesclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletestoragev1beta1collectionvolumeattributesclassHandler(cfg),
	}
}
