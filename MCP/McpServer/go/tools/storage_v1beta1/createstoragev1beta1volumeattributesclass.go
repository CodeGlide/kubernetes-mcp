...
func Createstoragev1beta1volumeattributesclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatestoragev1beta1volumeattributesclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_storage.k8s.io_v1beta1_volumeattributesclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createstoragev1beta1volumeattributesclassHandler(cfg),
	}
}
