...
func Replaceautoscalingv2namespacedhorizontalpodautoscalerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceautoscalingv2namespacedhorizontalpodautoscalerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_autoscaling_v2_namespaces_namespace_horizontalpodautoscalers_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceautoscalingv2namespacedhorizontalpodautoscalerHandler(cfg),
	}
}
