...
func Deleteautoscalingv2collectionnamespacedhorizontalpodautoscalerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/autoscaling/v2/namespaces/%s/horizontalpodautoscalers%s", cfg.BaseURL, queryString)
...
func CreateDeleteautoscalingv2collectionnamespacedhorizontalpodautoscalerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_autoscaling_v2_namespaces_namespace_horizontalpodautoscalers",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteautoscalingv2collectionnamespacedhorizontalpodautoscalerHandler(cfg),
	}
}
