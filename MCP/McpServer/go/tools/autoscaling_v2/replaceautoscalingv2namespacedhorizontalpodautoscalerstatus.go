...
func Replaceautoscalingv2namespacedhorizontalpodautoscalerstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiautoscalingv2HorizontalPodAutoscaler
		...
		url := fmt.Sprintf("%s/apis/autoscaling/v2/namespaces/%s/horizontalpodautoscalers/%s/status%s", cfg.BaseURL, queryString)
		...
		var result models.Iok8sapiautoscalingv2HorizontalPodAutoscaler
...
func CreateReplaceautoscalingv2namespacedhorizontalpodautoscalerstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_autoscaling_v2_namespaces_namespace_horizontalpodautoscalers_name_status",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceautoscalingv2namespacedhorizontalpodautoscalerstatusHandler(cfg),
	}
}
