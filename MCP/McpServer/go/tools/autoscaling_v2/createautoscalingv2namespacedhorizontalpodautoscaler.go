...
func Createautoscalingv2namespacedhorizontalpodautoscalerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateautoscalingv2namespacedhorizontalpodautoscalerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_autoscaling_v2_namespaces_namespace_horizontalpodautoscalers",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createautoscalingv2namespacedhorizontalpodautoscalerHandler(cfg),
	}
}
