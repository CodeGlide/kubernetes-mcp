...
func Listinternalapiserverv1alpha1storageversionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiapiserverinternalv1alpha1StorageVersionList
...
func CreateListinternalapiserverv1alpha1storageversionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_internal.apiserver.k8s.io_v1alpha1_storageversions",
		mcp.WithDescription("list or watch objects of kind StorageVersion"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listinternalapiserverv1alpha1storageversionHandler(cfg),
	}
}
