...
func Deleteinternalapiserverv1alpha1collectionstorageversionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/internal.apiserver.k8s.io/v1alpha1/storageversions%s", cfg.BaseURL, queryString)
...
func CreateDeleteinternalapiserverv1alpha1collectionstorageversionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_internal.apiserver.k8s.io_v1alpha1_storageversions",
		mcp.WithDescription("delete collection of StorageVersion"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteinternalapiserverv1alpha1collectionstorageversionHandler(cfg),
	}
}
