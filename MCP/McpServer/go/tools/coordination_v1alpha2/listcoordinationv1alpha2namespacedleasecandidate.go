...
func Listcoordinationv1alpha2namespacedleasecandidateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcoordinationv1alpha2namespacedleasecandidateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_coordination.k8s.io_v1alpha2_namespaces_namespace_leasecandidates",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcoordinationv1alpha2namespacedleasecandidateHandler(cfg),
	}
}
