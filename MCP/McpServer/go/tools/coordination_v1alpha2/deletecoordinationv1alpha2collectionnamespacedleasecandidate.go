...
func Deletecoordinationv1alpha2collectionnamespacedleasecandidateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/coordination.k8s.io/v1alpha2/namespaces/%s/leasecandidates%s", cfg.BaseURL, queryString)
...
func CreateDeletecoordinationv1alpha2collectionnamespacedleasecandidateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_coordination.k8s.io_v1alpha2_namespaces_namespace_leasecandidates",
		mcp.WithDescription("delete collection of LeaseCandidate"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecoordinationv1alpha2collectionnamespacedleasecandidateHandler(cfg),
	}
}
