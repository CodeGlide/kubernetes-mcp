...
func Replacecoordinationv1alpha2namespacedleasecandidateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapicoordinationv1alpha2LeaseCandidate
		...
		var result models.Iok8sapicoordinationv1alpha2LeaseCandidate
...
func CreateReplacecoordinationv1alpha2namespacedleasecandidateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_coordination.k8s.io_v1alpha2_namespaces_namespace_leasecandidates_name",
		mcp.WithDescription("replace the specified LeaseCandidate"),
		...
		mcp.WithObject("spec", mcp.Description("Input parameter: LeaseCandidateSpec is a specification of a Lease.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacecoordinationv1alpha2namespacedleasecandidateHandler(cfg),
	}
}
