...
func Createcoordinationv1alpha2namespacedleasecandidateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatecoordinationv1alpha2namespacedleasecandidateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_coordination.k8s.io_v1alpha2_namespaces_namespace_leasecandidates",
		mcp.WithDescription("create a LeaseCandidate"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createcoordinationv1alpha2namespacedleasecandidateHandler(cfg),
	}
}
