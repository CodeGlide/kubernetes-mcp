...
func Createbatchv1namespacedcronjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatebatchv1namespacedcronjobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_batch_v1_namespaces_namespace_cronjobs",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createbatchv1namespacedcronjobHandler(cfg),
	}
}
