...
func Replacebatchv1namespacedcronjobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapibatchv1CronJob
...
func CreateReplacebatchv1namespacedcronjobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_batch_v1_namespaces_namespace_cronjobs_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacebatchv1namespacedcronjobHandler(cfg),
	}
}
