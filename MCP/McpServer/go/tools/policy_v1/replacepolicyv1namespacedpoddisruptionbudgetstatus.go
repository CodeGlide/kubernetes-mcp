...
func Replacepolicyv1namespacedpoddisruptionbudgetstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapipolicyv1PodDisruptionBudget
		...
		url := fmt.Sprintf("%s/apis/policy/v1/namespaces/%s/poddisruptionbudgets/%s/status%s", cfg.BaseURL, queryString)
		...
		var result models.Iok8sapipolicyv1PodDisruptionBudget
...
func CreateReplacepolicyv1namespacedpoddisruptionbudgetstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_policy_v1_namespaces_namespace_poddisruptionbudgets_name_status",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacepolicyv1namespacedpoddisruptionbudgetstatusHandler(cfg),
	}
}
