...
func Createpolicyv1namespacedpoddisruptionbudgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatepolicyv1namespacedpoddisruptionbudgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_policy_v1_namespaces_namespace_poddisruptionbudgets",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createpolicyv1namespacedpoddisruptionbudgetHandler(cfg),
	}
}
