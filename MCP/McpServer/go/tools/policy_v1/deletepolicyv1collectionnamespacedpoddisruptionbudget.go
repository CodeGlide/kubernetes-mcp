...
func Deletepolicyv1collectionnamespacedpoddisruptionbudgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/policy/v1/namespaces/%s/poddisruptionbudgets%s", cfg.BaseURL, queryString)
...
func CreateDeletepolicyv1collectionnamespacedpoddisruptionbudgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_policy_v1_namespaces_namespace_poddisruptionbudgets",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletepolicyv1collectionnamespacedpoddisruptionbudgetHandler(cfg),
	}
}
