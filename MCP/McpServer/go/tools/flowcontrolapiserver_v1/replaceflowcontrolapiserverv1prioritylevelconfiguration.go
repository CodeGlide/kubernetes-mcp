...
func Replaceflowcontrolapiserverv1prioritylevelconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceflowcontrolapiserverv1prioritylevelconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_flowcontrol.apiserver.k8s.io_v1_prioritylevelconfigurations_name",
		mcp.WithDescription("replace the specified PriorityLevelConfiguration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceflowcontrolapiserverv1prioritylevelconfigurationHandler(cfg),
	}
}
