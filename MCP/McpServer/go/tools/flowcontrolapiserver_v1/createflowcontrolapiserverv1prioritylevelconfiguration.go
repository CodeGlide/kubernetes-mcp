...
func Createflowcontrolapiserverv1prioritylevelconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateflowcontrolapiserverv1prioritylevelconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_flowcontrol.apiserver.k8s.io_v1_prioritylevelconfigurations",
		mcp.WithDescription("create a PriorityLevelConfiguration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createflowcontrolapiserverv1prioritylevelconfigurationHandler(cfg),
	}
}
