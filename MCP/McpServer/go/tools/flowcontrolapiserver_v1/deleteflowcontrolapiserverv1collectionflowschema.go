...
func Deleteflowcontrolapiserverv1collectionflowschemaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/flowcontrol.apiserver.k8s.io/v1/flowschemas%s", cfg.BaseURL, queryString)
...
func CreateDeleteflowcontrolapiserverv1collectionflowschemaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_flowcontrol.apiserver.k8s.io_v1_flowschemas",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteflowcontrolapiserverv1collectionflowschemaHandler(cfg),
	}
}
