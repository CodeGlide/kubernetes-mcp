...
func Replaceflowcontrolapiserverv1flowschemaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceflowcontrolapiserverv1flowschemaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_flowcontrol.apiserver.k8s.io_v1_flowschemas_name",
		mcp.WithDescription("replace the specified FlowSchema"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceflowcontrolapiserverv1flowschemaHandler(cfg),
	}
}
