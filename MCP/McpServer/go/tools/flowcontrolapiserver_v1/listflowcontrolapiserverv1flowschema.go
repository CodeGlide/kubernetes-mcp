...
func Listflowcontrolapiserverv1flowschemaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiflowcontrolv1FlowSchemaList
...
func CreateListflowcontrolapiserverv1flowschemaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_flowcontrol.apiserver.k8s.io_v1_flowschemas",
		mcp.WithDescription("list or watch objects of kind FlowSchema"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listflowcontrolapiserverv1flowschemaHandler(cfg),
	}
}
