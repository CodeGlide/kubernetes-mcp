...
func Createflowcontrolapiserverv1flowschemaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateflowcontrolapiserverv1flowschemaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_flowcontrol.apiserver.k8s.io_v1_flowschemas",
		mcp.WithDescription("create a FlowSchema"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createflowcontrolapiserverv1flowschemaHandler(cfg),
	}
}
