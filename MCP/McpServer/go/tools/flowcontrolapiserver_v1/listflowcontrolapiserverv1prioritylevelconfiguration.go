...
func Listflowcontrolapiserverv1prioritylevelconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiflowcontrolv1PriorityLevelConfigurationList
...
func CreateListflowcontrolapiserverv1prioritylevelconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_flowcontrol.apiserver.k8s.io_v1_prioritylevelconfigurations",
		mcp.WithDescription("list or watch objects of kind PriorityLevelConfiguration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listflowcontrolapiserverv1prioritylevelconfigurationHandler(cfg),
	}
}
