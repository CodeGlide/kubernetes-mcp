...
func Replaceapiextensionsv1customresourcedefinitionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceapiextensionsv1customresourcedefinitionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_apiextensions.k8s.io_v1_customresourcedefinitions_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceapiextensionsv1customresourcedefinitionHandler(cfg),
	}
}
