...
func Deleteapiextensionsv1collectioncustomresourcedefinitionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/apiextensions.k8s.io/v1/customresourcedefinitions%s", cfg.BaseURL, queryString)
...
func CreateDeleteapiextensionsv1collectioncustomresourcedefinitionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_apiextensions.k8s.io_v1_customresourcedefinitions",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteapiextensionsv1collectioncustomresourcedefinitionHandler(cfg),
	}
}
