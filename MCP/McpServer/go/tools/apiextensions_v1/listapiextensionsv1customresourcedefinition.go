...
func Listapiextensionsv1customresourcedefinitionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListapiextensionsv1customresourcedefinitionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_apiextensions.k8s.io_v1_customresourcedefinitions",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listapiextensionsv1customresourcedefinitionHandler(cfg),
	}
}
