...
func Replacecertificatesv1beta1clustertrustbundleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapicertificatesv1beta1ClusterTrustBundle
		...
		var result models.Iok8sapicertificatesv1beta1ClusterTrustBundle
...
func CreateReplacecertificatesv1beta1clustertrustbundleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_certificates.k8s.io_v1beta1_clustertrustbundles_name",
		mcp.WithDescription("replace the specified ClusterTrustBundle"),
		...
		mcp.WithObject("spec", mcp.Required(), mcp.Description("Input parameter: ClusterTrustBundleSpec contains the signer and trust anchors.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacecertificatesv1beta1clustertrustbundleHandler(cfg),
	}
}
