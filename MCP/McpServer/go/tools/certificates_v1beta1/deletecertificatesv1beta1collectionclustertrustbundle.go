...
func Deletecertificatesv1beta1collectionclustertrustbundleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/certificates.k8s.io/v1beta1/clustertrustbundles%s", cfg.BaseURL, queryString)
...
func CreateDeletecertificatesv1beta1collectionclustertrustbundleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_certificates.k8s.io_v1beta1_clustertrustbundles",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecertificatesv1beta1collectionclustertrustbundleHandler(cfg),
	}
}
