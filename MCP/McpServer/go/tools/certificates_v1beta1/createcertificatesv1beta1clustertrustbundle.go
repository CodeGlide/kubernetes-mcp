...
func Createcertificatesv1beta1clustertrustbundleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatecertificatesv1beta1clustertrustbundleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_certificates.k8s.io_v1beta1_clustertrustbundles",
		mcp.WithDescription("create a ClusterTrustBundle"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createcertificatesv1beta1clustertrustbundleHandler(cfg),
	}
}
