...
func Listcertificatesv1beta1clustertrustbundleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapicertificatesv1beta1ClusterTrustBundleList
...
func CreateListcertificatesv1beta1clustertrustbundleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_certificates.k8s.io_v1beta1_clustertrustbundles",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcertificatesv1beta1clustertrustbundleHandler(cfg),
	}
}
