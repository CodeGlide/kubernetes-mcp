...
func Replacediscoveryv1namespacedendpointsliceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacediscoveryv1namespacedendpointsliceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_discovery.k8s.io_v1_namespaces_namespace_endpointslices_name",
		mcp.WithDescription("replace the specified EndpointSlice"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacediscoveryv1namespacedendpointsliceHandler(cfg),
	}
}
