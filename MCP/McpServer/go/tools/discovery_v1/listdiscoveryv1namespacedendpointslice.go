...
func Listdiscoveryv1namespacedendpointsliceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapidiscoveryv1EndpointSliceList
...
func CreateListdiscoveryv1namespacedendpointsliceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_discovery.k8s.io_v1_namespaces_namespace_endpointslices",
		mcp.WithDescription("list or watch objects of kind EndpointSlice"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listdiscoveryv1namespacedendpointsliceHandler(cfg),
	}
}
