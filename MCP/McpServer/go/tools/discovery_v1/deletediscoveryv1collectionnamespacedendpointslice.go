...
func Deletediscoveryv1collectionnamespacedendpointsliceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletediscoveryv1collectionnamespacedendpointsliceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_discovery.k8s.io_v1_namespaces_namespace_endpointslices",
		mcp.WithDescription("delete collection of EndpointSlice"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletediscoveryv1collectionnamespacedendpointsliceHandler(cfg),
	}
}
