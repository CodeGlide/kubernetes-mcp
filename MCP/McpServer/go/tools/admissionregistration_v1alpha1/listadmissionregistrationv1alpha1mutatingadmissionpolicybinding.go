...
func Listadmissionregistrationv1alpha1mutatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiadmissionregistrationv1alpha1MutatingAdmissionPolicyBindingList
...
func CreateListadmissionregistrationv1alpha1mutatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_admissionregistration.k8s.io_v1alpha1_mutatingadmissionpolicybindings",
		mcp.WithDescription("list or watch objects of kind MutatingAdmissionPolicyBinding"),
		mcp.WithBoolean("allowWatchBookmarks", mcp.Description("allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listadmissionregistrationv1alpha1mutatingadmissionpolicybindingHandler(cfg),
	}
}
