...
func Replaceadmissionregistrationv1alpha1mutatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiadmissionregistrationv1alpha1MutatingAdmissionPolicyBinding
		...
		var result models.Iok8sapiadmissionregistrationv1alpha1MutatingAdmissionPolicyBinding
...
func CreateReplaceadmissionregistrationv1alpha1mutatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_admissionregistration.k8s.io_v1alpha1_mutatingadmissionpolicybindings_name",
		mcp.WithDescription("replace the specified MutatingAdmissionPolicyBinding"),
		...
		mcp.WithObject("spec", mcp.Description("Input parameter: MutatingAdmissionPolicyBindingSpec is the specification of the MutatingAdmissionPolicyBinding.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Replaceadmissionregistrationv1alpha1mutatingadmissionpolicybindingHandler(cfg),
	}
}
