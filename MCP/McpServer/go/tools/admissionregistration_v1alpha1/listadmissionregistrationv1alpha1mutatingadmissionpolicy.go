...
func Listadmissionregistrationv1alpha1mutatingadmissionpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiadmissionregistrationv1alpha1MutatingAdmissionPolicyList
...
func CreateListadmissionregistrationv1alpha1mutatingadmissionpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_admissionregistration.k8s.io_v1alpha1_mutatingadmissionpolicies",
		mcp.WithDescription("list or watch objects of kind MutatingAdmissionPolicy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listadmissionregistrationv1alpha1mutatingadmissionpolicyHandler(cfg),
	}
}
