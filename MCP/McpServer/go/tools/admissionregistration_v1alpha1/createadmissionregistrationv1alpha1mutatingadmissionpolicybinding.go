...
func Createadmissionregistrationv1alpha1mutatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateadmissionregistrationv1alpha1mutatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_admissionregistration.k8s.io_v1alpha1_mutatingadmissionpolicybindings",
		mcp.WithDescription("create a MutatingAdmissionPolicyBinding"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createadmissionregistrationv1alpha1mutatingadmissionpolicybindingHandler(cfg),
	}
}
