...
func Createadmissionregistrationv1alpha1mutatingadmissionpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateadmissionregistrationv1alpha1mutatingadmissionpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_admissionregistration.k8s.io_v1alpha1_mutatingadmissionpolicies",
		mcp.WithDescription("create a MutatingAdmissionPolicy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createadmissionregistrationv1alpha1mutatingadmissionpolicyHandler(cfg),
	}
}
