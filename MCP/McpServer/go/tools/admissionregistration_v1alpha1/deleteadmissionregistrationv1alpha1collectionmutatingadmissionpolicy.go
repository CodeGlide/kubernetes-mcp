...
func Deleteadmissionregistrationv1alpha1collectionmutatingadmissionpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/admissionregistration.k8s.io/v1alpha1/mutatingadmissionpolicies%s", cfg.BaseURL, queryString)
...
func CreateDeleteadmissionregistrationv1alpha1collectionmutatingadmissionpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_admissionregistration.k8s.io_v1alpha1_mutatingadmissionpolicies",
		mcp.WithDescription("delete collection of MutatingAdmissionPolicy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteadmissionregistrationv1alpha1collectionmutatingadmissionpolicyHandler(cfg),
	}
}
