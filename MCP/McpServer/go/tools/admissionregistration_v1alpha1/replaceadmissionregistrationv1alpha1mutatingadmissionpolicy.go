...
func Replaceadmissionregistrationv1alpha1mutatingadmissionpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiadmissionregistrationv1alpha1MutatingAdmissionPolicy
		...
		var result models.Iok8sapiadmissionregistrationv1alpha1MutatingAdmissionPolicy
...
func CreateReplaceadmissionregistrationv1alpha1mutatingadmissionpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_admissionregistration.k8s.io_v1alpha1_mutatingadmissionpolicies_name",
		mcp.WithDescription("replace the specified MutatingAdmissionPolicy"),
		...
		mcp.WithObject("spec", mcp.Description("Input parameter: MutatingAdmissionPolicySpec is the specification of the desired behavior of the admission policy.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceadmissionregistrationv1alpha1mutatingadmissionpolicyHandler(cfg),
	}
}
