...
func Deletestoragemigrationv1alpha1collectionstorageversionmigrationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations%s", cfg.BaseURL, queryString)
...
func CreateDeletestoragemigrationv1alpha1collectionstorageversionmigrationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storagemigration.k8s.io_v1alpha1_storageversionmigrations",
		mcp.WithDescription("delete collection of StorageVersionMigration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletestoragemigrationv1alpha1collectionstorageversionmigrationHandler(cfg),
	}
}
