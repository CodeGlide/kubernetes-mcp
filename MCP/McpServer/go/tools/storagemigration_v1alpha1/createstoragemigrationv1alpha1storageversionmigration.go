...
func Createstoragemigrationv1alpha1storageversionmigrationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatestoragemigrationv1alpha1storageversionmigrationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_storagemigration.k8s.io_v1alpha1_storageversionmigrations",
		mcp.WithDescription("create a StorageVersionMigration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createstoragemigrationv1alpha1storageversionmigrationHandler(cfg),
	}
}
