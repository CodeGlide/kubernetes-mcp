...
func Liststoragemigrationv1alpha1storageversionmigrationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapistoragemigrationv1alpha1StorageVersionMigrationList
...
func CreateListstoragemigrationv1alpha1storageversionmigrationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_storagemigration.k8s.io_v1alpha1_storageversionmigrations",
		mcp.WithDescription("list or watch objects of kind StorageVersionMigration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Liststoragemigrationv1alpha1storageversionmigrationHandler(cfg),
	}
}
